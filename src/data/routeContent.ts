...
export const routeEvents: RouteDecisionDefinition[] = [
  {
    ...
    routes: ["mistwoodEdge"],
    choices: [
      { id: "follow", label: "Follow the signs", detail: "Requires SURV 7.", requirement: { minStat: { stat: "surv", value: 7 } }, effect: { resources: { food: 3, wood: 2 }, score: 8, flag: "followed-old-signs" }, result: "The markings lead to a dry cache." },
  ...
  },
  {
    ...
    routes: ["burntGrove"],
    choices: [
      { id: "harvest", label: "Harvest carefully", detail: "Requires WIS 6.", requirement: { minStat: { stat: "wis", value: 6 } }, effect: { resources: { herb: 4, food: 2 }, score: 10, flag: "ash-fruit" }, result: "The fruit cools into useful medicine." },
  ...
  },
  {
    ...
    choices: [
      { id: "decode", label: "Decode the tide runes", detail: "Requires WIS 7.", requirement: { minStat: { stat: "wis", value: 7 } }, effect: { resources: { relicShard: 2 }, score: 12, flag: "tide-runes" }, result: "The runes release two cold relic shards." },
  ...
  },
  {
    ...
    choices: [
      { id: "leap", label: "Leap the span", detail: "Requires SPD 7.", requirement: { minStat: { stat: "spd", value: 7 } }, effect: { routeProgress: 1, score: 10, fatigue: 2, flag: "crossed-storm-bridge" }, result: "The fastest survivor secures a line across." },
  ...
  },
  {
    ...
    choices: [
      { id: "listen", label: "Listen to the roots", detail: "Herbalist only.", requirement: { classId: "herbalist" }, effect: { resources: { herb: 5 }, injury: -4, score: 10, flag: "root-memory" }, result: "The roots share medicine and an old warning." },
  ...
  },
  {
    ...
    choices: [
      { id: "study", label: "Study the reflection", detail: "Requires WIS 8.", requirement: { minStat: { stat: "wis", value: 8 } }, effect: { resources: { relicShard: 2 }, score: 14, flag: "moon-vision" }, result: "A future route settles into memory." },
  ...
  },
  {
    ...
    choices: [
      { id: "tool", label: "Open with tools", detail: "Tinker only.", requirement: { classId: "tinker" }, effect: { items: { repairKit: 1 }, score: 8, flag: "opened-cinder-cache" }, result: "The lock yields without damaging the repair kit inside." },
  ...
  },
  {
    ...
    choices: [
      { id: "climb", label: "Climb into the nest", detail: "Requires SPD 6.", requirement: { minStat: { stat: "spd", value: 6 } }, effect: { resources: { ore: 4 }, fatigue: 4, score: 8 }, result: "The climber recovers storm-polished ore." },
...
export const normalEncounters: RouteDecisionDefinition[] = [
  {
    ...
    choices: [
      { id: "hunt", label: "Break the pack", detail: "Hunter only.", requirement: { classId: "hunter" }, effect: { resources: { food: 5 }, fatigue: 3, score: 8 }, result: "The Hunter drives off the pack and salvages food." },
  ...
  },
  {
    ...
    choices: [
      { id: "cleanse", label: "Herbal cleanse", detail: "Herbalist only.", requirement: { classId: "herbalist" }, effect: { resources: { herb: 3 }, injury: -3, score: 8 }, result: "The Herbalist turns the swarm into useful reagents." },
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "challenge", label: "Challenge their leader", detail: "Requires ATK 8.", requirement: { minStat: { stat: "atk", value: 8 } }, effect: { resources: { ore: 4 }, injury: 2, score: 10 }, result: "The leader yields the barricade's best salvage." },
