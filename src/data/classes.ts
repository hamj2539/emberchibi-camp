...
export const starterClasses: StarterClass[] = [
  {
    ...
    strengths: ["Faster route progress", "Lower ambush risk", "Better Beacon discovery"],
  ...
  },
  {
    ...
    strengths: ["Strong attacks", "Better food yield", "Strong against beasts"],
  ...
  },
  {
    ...
    strengths: ["Heals injuries", "Clears status effects", "Efficient herb use"],
